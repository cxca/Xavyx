...
//    _confirmEmailTextField.delegate = self;
...
//		[_confirmEmailTextField becomeFirstResponder];
//	}
    else if (textField == _eMailTextField) {
...
//        [_confirmEmailTextField resignFirstResponder];
//    }
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string  {
    ...
    if(textField == _eMailTextField || textField == _confirmEmailTextField)
...
//        LoginRegisterViewController *loginController;
        ...
        if(INTERFACE_IS_PAD)
        {
            ...
            [self dismissViewControllerAnimated:YES completion:^{
                LoginRegisterViewController *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"LoginRegisterViewController"];
//                sleep(0.5);
